 ...
 */
final class Version20201130100524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competence ADD statut TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE tags ADD statut TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competence DROP statut');
        $this->addSql('ALTER TABLE tags DROP statut');
    }
}
