 ...
 */
final class Version20201202154413 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel ADD presentation LONGTEXT NOT NULL, ADD programme LONGBLOB NOT NULL, ADD critere_evaluation VARCHAR(255) NOT NULL, ADD critere_admission VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel DROP presentation, DROP programme, DROP critere_evaluation, DROP critere_admission');
    }
}
