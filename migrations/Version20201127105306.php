 ...
 */
final class Version20201127105306 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE niveau ADD critere_evaluation VARCHAR(255) NOT NULL, ADD groupe_action VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE niveau DROP critere_evaluation, DROP groupe_action');
    }
}
