 ...
 */
final class Version20210111002110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE profil_sortie_promo (profil_sortie_id INT NOT NULL, promo_id INT NOT NULL, INDEX IDX_5F9B40766409EF73 (profil_sortie_id), INDEX IDX_5F9B4076D0C07AFF (promo_id), PRIMARY KEY(profil_sortie_id, promo_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
